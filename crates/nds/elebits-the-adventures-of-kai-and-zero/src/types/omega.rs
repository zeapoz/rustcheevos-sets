...
impl Omega {
    ...
    pub fn save_data_obtained_state(self) -> MemoryRef {
        let offset =
            mem::omega_vector_save_data_file_1() + (self.id() * Self::STRUCT_SIZE_BYTES) as usize;
        bits8!(offset + 6)
    }
...
impl fmt::Display for Omega {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Omega::Ice => write!(f, "Ice Omega"),
            Omega::XIce => write!(f, "X Ice Omega"),
            Omega::Mirror => write!(f, "Mirror Omega"),
            Omega::Fire => write!(f, "Fire Omega"),
            Omega::XFire => write!(f, "X Fire Omega"),
            Omega::Water => write!(f, "Water Omega"),
            Omega::XWater => write!(f, "X Water Omega"),
            Omega::Sponge => write!(f, "Sponge Omega"),
            Omega::Earth => write!(f, "Earth Omega"),
            Omega::XEarth => write!(f, "X Earth Omega"),
            Omega::Magnet => write!(f, "Magnet Omega"),
            Omega::XMagnet => write!(f, "X Magnet Omega"),
            Omega::Wind => write!(f, "Wind Omega"),
            Omega::XWind => write!(f, "X Wind Omega"),
            Omega::Time => write!(f, "Time Omega"),
            Omega::Power => write!(f, "Power Omega"),
            Omega::XPower => write!(f, "X Power Omega"),
            Omega::Surf => write!(f, "Surf Omega"),
            Omega::Flight => write!(f, "Flight Omega"),
            Omega::Speed => write!(f, "Speed Omega"),
            Omega::Melody => write!(f, "Melody Omega"),
            Omega::XMelody => write!(f, "X Melody Omega"),
            Omega::Warp => write!(f, "Warp Omega"),
            Omega::Radar => write!(f, "Radar Omega"),
            Omega::Blizzard => write!(f, "Blizzard Omega"),
            Omega::Flame => write!(f, "Flame Omega"),
            Omega::Aqua => write!(f, "Aqua Omega"),
            Omega::Land => write!(f, "Land Omega"),
            Omega::Storm => write!(f, "Storm Omega"),
            Omega::Strong => write!(f, "Strong Omega"),
