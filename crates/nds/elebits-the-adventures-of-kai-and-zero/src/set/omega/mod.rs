...
pub fn generate_omega_achievements() -> Vec<Achievement> {
    let mut result = vec![
        ...
        obtain_standard_omega_achievement("In Tune", "Play a scale and obtain the Melody Omega", Omega::Melody, Location::ElebitMine),
        obtain_standard_omega_achievement("Opposites Attract", "Encounter a mysterious kid and obtain the Magnet Omega", Omega::Magnet, Location::ElebitMine),
        ...
        obtain_standard_omega_achievement("Muscle Memory", "Find and obtain the Strong Omega", Omega::Strong, Location::ElebitMine),
